...
/**
 * Класс описывает работу простейшей очереди по приоритету, которая
...
public class PriorityQueue {
    ...
    /**
     * Метод принимает на вход заявку и принимает ее в очередь
     * Если встречаются № задания с одинаковым приоритетом, то в очереди
