...
public class CollegeTest {
    ...
    public void whenAccountIsOptionalEmpty() {
        ...
        Assert.assertThat(college.findByAccount("000010"), is(Optional.empty()));
    }
    ...
    public void whenAccountIsOptionalNotEmpty() {
        ...
        College college = new College(students);
        Assert.assertThat(college.findByAccount("000001").get().getGroup(), is("201-18-15"));
    }
    ...
    public void whenSubjectIsOptionalNotEmpty() {
        ...
        College college = new College(students);
        Assert.assertThat(college.findBySubjectName("000002", "Sociology")
                .get()
                .getScore(),
                is(65));
    }
